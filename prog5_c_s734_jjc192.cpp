...
void printIdInfo ( ostream &, string first1, string last1, string first2,
                   string last2, const string CLASS, string section,
                   string lab_section1, string lab_section2,
...
void printIdInfo ( ostream &fout, string first1, string last1, string first2,
                   string last2, const string CLASS, string section,
                   string lab_section1, string lab_section2,
                   const string DUE_DATE )
{
   fout << first1 << " " << last1 << " & " << first2 << " " << last2 << endl
        << CLASS << "." << section << endl
